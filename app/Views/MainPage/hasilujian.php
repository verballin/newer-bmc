...
<!-- Header End -->
    ...
    <div class="container py-5 text-center">
        ...
        <?php if ($lulus): ?>
            <div class="alert alert-success">Selamat! Anda lulus ujian 🎉</div>
        <?php else: ?>
            <div class="alert alert-danger">Maaf, Anda belum lulus.</div>
        <?php endif; ?>

        <a href="<?= site_url('pilihujian') ?>" class="btn btn-primary mt-3">Kembali ke Daftar Ujian</a>
    </div>
