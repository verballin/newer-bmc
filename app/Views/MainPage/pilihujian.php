    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
                <h1 class="display-3 text-white animated slideInDown"> Pilih Ujian</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item"><a class="text-white" href="<?= base_url() ?>">Beranda</a></li>
                        <li class="breadcrumb-item"><a class="text-white" href="<?= site_url('pilihujian') ?>"> Pilih Ujian</a></li>
...
<!-- Header End -->
  ...
  <!-- Konten Pilih Ujian -->
    <div class="container py-5">
        <h3 class="mb-4 text-center">Silakan pilih ujian yang ingin Anda ikuti</h3>
        <div class="row">
            <?php foreach ($pengaturan as $item): ?>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title text-primary"><?= esc($item['nama_ujian']) ?></h5>
                            <p class="card-text mb-2"><strong>Durasi:</strong> <?= esc($item['waktu']) ?> menit</p>
                            <p class="card-text mb-4"><strong>Nilai Minimum:</strong> <?= esc($item['nilai_minimal']) ?>%</p>
                            <a href="<?= site_url('mulaiujian/' . $item['id_pengaturan']) ?>" class="btn btn-outline-primary mt-auto rounded-pill">
                                <i class="bi bi-file-earmark-text me-1"></i> Mulai Ujian
                            </a>
                        </div>
                    </div>
                </div>
