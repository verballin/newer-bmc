        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Laporan Penjualan</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="<?= base_url() ?>">Beranda</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Laporan Penjualan</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container mb-5 laporan-container">
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th>Nama Kursus</th>
                    <th>Jumlah Pembelian (Paid)</th>
                    <th>Jumlah Pembelian (Pending)</th>
                </tr>
            </thead>
            <tbody>
        ...
        <p><strong>Kursus Terlaris:</strong> <?= esc($kursus_terlaris) ?></p>
    </div>
